...
if __name__ == "__main__":
    print("Running Stationary MAIN!!!")
    print("Connecting to the vehicle...")
    copter = Copter(sysid=int(config['stationary']['sysid']))
    copter.connect(connection_string=str(config['stationary']['connection_string']))
